                    ...
                    <form method="POST" action="{{ route('tipodocumentacions.store') }}">
                        ...
                        <div class="mt-4">
                            <x-jet-label for="esglobal" value="Es Global" class="text-white" /> <span
                                title="Si es global, se puede utilizar en todos los mercados"
                            ...
                            <select id="global" class="block w-full mt-1" type="text" name="global" required>
                                <option value="">Seleccione Globalidad del Documento</option>
                        ...
                        <div class="mt-4">
                            ...
                            <select id="pais_id" class="block w-full mt-1" type="text" name="pais_id" required>
                        ...
                        <div class="mt-4">
                            ...
                            <select id="especie_id" class="block w-full mt-1" type="text" name="especie_id" required>
                        ...
                        <div>
                            ...
                            <x-jet-input id="nombre" class="block w-full mt-1" type="text" name="nombre"
                                value="" required autofocus autocomplete="nombre" />
                        </div>
                        ...
                        <div>
                            ...
                            <x-jet-input id="nombre_guardado" class="block w-full mt-1" type="text"
                                name="nombre_guardado" value="" required autofocus
                                autocomplete="nombre guardado" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input id="obligatorio" class="block mt-1" type="checkbox" name="obligatorio"
                                value="1" autofocus autocomplete="Obligatorio" />
                        </div>
                        ...
                        <div>
                            ...
                            <input id="creado_por_nombre" class="block w-full mt-1" type="text" @readonly(true)
                                name="creado_por_nombre" value="{{ $user->name }}" autofocus
