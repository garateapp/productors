<div>
    <main class="flex w-full h-full shadow-lg rounded-3xl">
        ...
        <section class="block sm:flex flex-col pt-3 w-12/12 sm:w-4/12 bg-gray-50 h-full overflow-y-scroll order-2 lg:col-span-2 lg:order-1">
          <label class="px-3">
        ...
        <section class="w-12/12 sm:w-6/12 px-4 block sm:flex flex-col bg-white rounded-r-3xl order-1 lg:order-2">
            @if ($current)
