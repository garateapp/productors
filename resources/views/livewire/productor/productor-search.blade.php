                                ...
                                @foreach ($users->reverse() as $user)
                                    ...
                                    <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                                        ...
                                        <td class="pl-5 text-white">
                                            {!! Form::submit('Actualizar', ['class'=>'mx-4 focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 mt-4 sm:mt-0 inline-flex items-start justify-start px-6 py-3 bg-gray-500 hover:bg-gray-500 focus:outline-none rounded']) !!}
                                            {!! Form::close() !!}
                                        </td>
                                        <td class="pl-5">
