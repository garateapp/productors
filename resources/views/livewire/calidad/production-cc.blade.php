                                                ...
                                                <tr tabindex="0" class="focus:outline-none h-20 border border-gray-100 rounded">
                                                        ...
                                                        <td class="pl-5 whitespace-nowrap">
                                                                 ...
                                                                 @if ($recepcion->calidad->detalles->where('tipo_item','DISTRIBUCIÓN DE FIRMEZA')->count())
                                                                    <button class="mb-4 focus:ring-2 focus:ring-offset-2 focus:ring-green-300 text-sm leading-none text-green-600 py-3 px-5 bg-green-100 rounded hover:bg-green-200 focus:outline-none">
                                                                        FIRMPRO CARGADO
                                                                    </button>
                                                                @else
