                                        ...
                                        <td class="pl-5 whitespace-nowrap">
                                            <p class="whitespace-nowrap  text-base flex font-medium leading-none text-gray-700 mr-2">
                                                ...
                                                @if ($detalle->tipo_item!='DISTRIBUCIÓN DE CALIBRES')
                                                    ...
                                                    @endif
                                                @elseif($recep->n_especie=='Orange' || $recep->n_especie=='Peaches' || $recep->n_especie=='Apples' || $recep->n_especie=='Pears' || $recep->n_especie=='Nectarines' || $recep->n_especie=='Plums' || $recep->n_especie=='Mandarinas' || $recep->n_especie=='Membrillos')
                                                    @if ($detalle->porcentaje_muestra)
                                                        {{$detalle->porcentaje_muestra}}
                                                    @endif
                                                @endif
