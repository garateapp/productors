...
<body>
	...
	<div class="container">
		...
		<h1 style="background-color: rgb(0,0,0,0.5);" >Informe de Recepcion Guia N° {{$recepcion->numero_g_recepcion}} | {{$recepcion->n_especie}} | <br> {{$recepcion->n_variedad}} | Cuartel GE001 | CSG <br> {{$recepcion->id_emisor}} </h1>
	</div>
