...
<body>
	...
	<div class="container">
		...
		<table style="width:100%; background-color:#ececec;">
			...
			border-radius: 5px;"><h3  style="color: teal;">T°<br> Pulpa</h3>
						...
						{{$recepcion->calidad->detalles->where('tipo_detalle','ss')->where('detalle_item','SOLIDOS SOLUBLES')->first()->temperatura}}°C
					</td>
				@endif
	...
	@if ($recepcion->n_especie!='Pears' && $recepcion->n_especie!='Peaches' && $recepcion->n_especie!='Apples') 
