    ...
    <div class="flex flex-col sm:justify-center items-center sm:pt-4">
        ...
        @if (session('info'))
            <div x-data="{ open: true }">
                <div x-show="open" class="bg-white border border-gray-400 text-gray-700 px-4 py-3 rounded relative flex"
                    role="alert">
                    ...
                    <span x-on:click="open=false" class="top-0 bottom-0 right-0 px-4 py-3 ">
                        <svg class="fill-current h-6 w-6 text-gray-500 ml-4" role="button"
        ...
        @if (session('fail'))
            <div x-data="{ open: true }">
                <div x-show="open"
                    class="bg-white border border-gray-400 text-gray-700 px-4 py-3 rounded relative flex"
                    role="alert">
        ...
        <div class="container  m-4">
            <div class="max-w-3xl w-full mx-auto grid gap-4 grid-cols-1">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex flex-col">
                                            ...
                                            <div class="flex-auto text-gray-400 my-1">
                                                <span class="mr-3 ">Productor</span><span
                ...
                <div class="grid gap-4 grid-cols-1 md:grid-cols-1">
                    ...
                    <!--confirm modal-->
                    <div
                        class="flex flex-col p-4 relative items-center justify-center bg-gray-800 border border-gray-800 shadow-lg  rounded-2xl hidden">
                        <div class="">
                            ...
                            <a href="{{ Route('productor.edit', $campo->user) }}" target="_blank">
                                <div
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center mr-auto">
                                            <div class="inline-flex w-12 h-12"><img
                                                    ...
                                                    alt="aji"
                                                    class=" relative p-1 w-12 h-12 object-cover rounded-2xl"><span
                                        ...
                                        <div class="flex flex-col ml-3 min-w-0">
                                            <div class="flex">
                                                <h5 class="flex items-center font-medium text-gray-300 mr-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mx-4"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="h-6 w-6 text-yellow-400 ml-2" viewBox="0 0 20 20"
                                                    fill="currentColor">
                                                    <path fill-rule="evenodd"
                                                ...
                                                <form action="{{ route('campostaffs.destroy', $campo) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('delete')
                                                    <button>
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            ...
                                                            stroke="currentColor"
                                                            class="h-6 w-6 text-red-400 hover:text-red-800 ml-2">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <div class="grid grid-cols-6 gap-y-2 mt-2">
                                        @foreach ($campo->user->especies_comercializas()->get() as $ficha)
                                            <div class="flex justify-center">
                                                <span
                                                    class="cursor-pointer py-3 px-3 text-sm focus:outline-none leading-none rounded @if (
                                                        !IS_NULL($ficha->ano_plantacion) &&
                                                            !IS_NULL($ficha->cant_hectareas) &&
                                                            !IS_NULL($ficha->prod_hectareas) &&
                                                            !IS_NULL($ficha->total_produccion) &&
                                                            !IS_NULL($ficha->porcentaje_de_entrega)) text-gray-700 bg-green-200 @else text-gray-700 bg-yellow-200 @endif">{{ $ficha->name }}</span>
                                            </div>
                                        @endforeach
