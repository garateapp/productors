    ...
    <div class="flex flex-col items-center sm:justify-center sm:pt-4" >
      ...
      @if (session('info'))
          <div x-data="{open: true}">
            <div x-show="open"  class="relative flex px-4 py-3 text-gray-700 bg-white border border-gray-400 rounded" role="alert">
                ...
                <svg class="w-6 h-6 ml-4 text-gray-500 fill-current" role="button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><title>Close</title><path d="M14.348 14.849a1.2 1.2 0 0 1-1.697 0L10 11.819l-2.651 3.029a1.2 1.2 0 1 1-1.697-1.697l2.758-3.15-2.759-3.152a1.2 1.2 0 1 1 1.697-1.697L10 8.183l2.651-3.031a1.2 1.2 0 1 1 1.697 1.697l-2.758 3.152 2.758 3.15a1.2 1.2 0 0 1 0 1.698z"/></svg>
                </span>
            </div>
        </div>
      @endif
        ...
        <div class="container m-4">
          <div class="grid w-full max-w-3xl grid-cols-1 gap-4 mx-auto">
              ...
              <div class="p-4 bg-gray-800 border border-gray-300 shadow-lg rounded-2xl">
                <div class="flex-none sm:flex">
                  <div class="relative w-32 h-32 mb-3 sm:mb-0">
                    <img src="{{$user->profile_photo_url}}" alt="aji" class="object-cover w-32 h-32 rounded-2xl">
                    <a href="#" class="absolute p-1 -ml-3 text-xs font-medium tracking-wider text-white transition duration-300 ease-in bg-green-400 rounded-full -right-2 bottom-2 hover:bg-green-500">
                    ...
                    <div class="flex items-center justify-between sm:mt-2">
                      <div class="flex items-center">
                        <div class="flex flex-col">
                          ...
                          <div class="flex-none w-full text-lg font-bold leading-none text-gray-200">{{$user->name}}</div>
                  ...
                  <div class="">
                    @if ($user->status)
                      <div class="p-2 my-auto mb-2 text-center text-white bg-green-500 rounded-lg">
                    ...
                    <div class="flex flex-row items-center">
                      <div class="flex">
                        ...
                        </svg><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5 text-yellow-400">
                          <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z">
                          </path>
                        </svg><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5 text-yellow-400">
                          <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z">
                      ...
                      <div class="inline-flex items-center flex-1 hidden ml-2 space-x-2">
                        <a hre="https://www.behance.net/ajeeshmon" target="_blank"><svg class="w-5 h-5 p-1 transition duration-300 ease-in cursor-pointer rounded-2xl hover:bg-blue-500 hover:text-white" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 172 172" style=" fill:#4a90e2;">
                        ...
                        <a hre="https://www.linkedin.com/in/ajeeshmon" target="_blank"><svg class="w-5 h-5 p-1 transition duration-300 ease-in cursor-pointer rounded-2xl hover:bg-blue-500 hover:text-white" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 172 172" style=" fill:#ffffff;">
                            <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal">
                              <path d="M0,172v-172h172v172z" fill="none"></path>
                              <g fill="#ffffff">
                        ...
                        <a hre="https://twitter.com/ajeemon?lang=en" target="_blank"><svg class="w-5 h-5 p-1 transition duration-300 ease-in cursor-pointer rounded-2xl hover:bg-blue-400 hover:text-white" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 172 172" style=" fill:#ffffff;">
                            <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal">
                              <path d="M0,172v-172h172v172z" fill="none"></path>
                              <g fill="#ffffff">
                ...
                <div x-data="{open:false}">
                      ...
                      <div>
                        <div class="flex items-center">
                            {!! Form::label('name','¿Posee alguna certificación?') !!}
                              <div class="px-4 py-2 ml-2 text-white bg-green-500 rounded-lg cursor-pointer" x-on:click="open=true">
                                SI
                              </div>
                            ...
                            <div class="flex mt-2 mb-4">
                              ...
                              <div class="p-2 ml-2 text-white bg-gray-500 rounded-lg cursor-pointer" x-on:click="open=!open">
                                AGREGAR MÁS
                              </div>
                            </div>
                      </div>
                        <div class="grid grid-cols-1">
                          ...
                          @foreach ($certificacions as $certificacion)
                              <div class="flex items-center">
                                ...
                                @else
                                    <a href="{{asset('storage')}}/{{ $certificacion->documento }}" target="_blank" title="Ver Certificación" class="mb-2 ml-2 text-xs text-blue-500 cursor-pointer fa-solid fas fa-file-pdf">

                                      </a>
                                      @endif
                                    @csrf
                                    @method('delete')
                                    <button type="button" class="mb-2 ml-2 text-xs font-bold text-red-500 deleteButtoncert fas fa-trash">
                  ...
                  @else
                      ...
                      {!! Form::open(['route'=>'certificacions.store','files'=>true , 'autocomplete'=>'off', 'method'=> 'POST']) !!}
                        ...
                        <div class="flex mt-2 mb-4">
                          <div class="px-4 py-2 text-white bg-green-500 rounded-lg cursor-pointer" x-on:click="open=true">
                            SI
                          </div>
                          <div class="p-2 ml-2 text-white bg-red-500 rounded-lg cursor-pointer" x-on:click="open=false">
                            NO
                          </div>
                        </div>
                    ...
                    <div class="grid grid-cols-6 gap-y-2">
                      ...
                      @foreach ($especiesUnicas as $ficha)
                          <div class="flex justify-center hidden">
                              <button class="px-3 py-3 text-sm leading-none text-green-700 bg-green-100 rounded focus:outline-none">{{$ficha->especie->name}}</button>
                          </div>
                          @php
                      ...
                      <ul class="flex items-center justify-center mt-2 mb-6">
                        <template x-for="(tab, index) in tabs" :key="index">
                          <li class="px-4 py-3 transition rounded cursor-pointer" :class="activeTab===index ? 'bg-red-500 text-white' : ' text-gray-500'" @click="activeTab = index"
                              x-text="tab"></li>
                        </template>
                      </ul>
                    ...
                    @foreach ($especiesUnicas as $item)
                        @foreach ($user->fichas->sortBy('cuartel') as $ficha)
                          @if ($item->especie_id==$ficha->especie_id)
                            ...
                            <div x-show="activeTab==={{$k}}" class="flex flex-col p-4 transition duration-500 ease-in transform bg-gray-800 border-gray-800 shadow-md cursor-pointer hover:shodow-lg rounded-2xl hover:scale-105">

                                <div class="flex items-center justify-between">
                                  <div class="flex items-center mr-auto">
                                    <div class="inline-flex w-12 h-12"><img src="https://tailwindcomponents.com/storage/avatars/njkIbPhyZCftc4g9XbMWwVsa7aGVPajYLRXhEeoo.jpg" alt="aji" class="relative object-cover w-12 h-12 p-1 rounded-2xl"><span class="absolute inline-flex w-12 h-12 border-2 border-gray-600 opacity-75 rounded-2xl"></span>
                                      <span></span>
                                    </div>

                                    <div class="flex flex-col min-w-0 ml-3">
                                      <div class="font-medium leading-none text-gray-100">Cuartel Nro: {{$ficha->cuartel}}</div>
                                      <p class="mt-1 text-sm leading-none text-gray-500 truncate">{{$ficha->especie->name}}</p>
                                    </div>
                                  </div>
                                  <div class="flex flex-col min-w-0 ml-3">
                                    <div class="flex items-center">
                                      <h5 class="flex items-center mr-2 font-medium text-gray-300">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mx-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <form class="deleteForm" action="{{ route('fichas.destroy', $ficha) }}" method="POST">
                                            ...
                                            <button type="button" class="deleteButton">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 ml-2 text-red-400 hover:text-red-800">
            ...
            <div class="grid hidden grid-cols-12 gap-4">
              <div class="col-span-12 sm:col-span-4">
                <div class="relative p-4 bg-gray-800 border border-gray-800 shadow-lg rounded-2xl">
                  <svg xmlns="http://www.w3.org/2000/svg" class="absolute text-green-400 h-14 w-14 bottom-4 right-3" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div class="col-span-12 sm:col-span-4">
                <div class="relative p-4 bg-gray-800 border border-gray-800 shadow-lg rounded-2xl">
                  <svg xmlns="http://www.w3.org/2000/svg" class="absolute text-blue-500 h-14 w-14 bottom-4 right-3" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div class="col-span-12 sm:col-span-4">
                <div class="relative p-4 bg-gray-800 border border-gray-800 shadow-lg rounded-2xl">
                  <svg xmlns="http://www.w3.org/2000/svg" class="absolute text-yellow-300 h-14 w-14 bottom-4 right-3" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-1">
              ...
              <!--confirm modal-->
              <div class="relative flex flex-col items-center justify-center hidden p-4 bg-gray-800 border border-gray-800 shadow-lg rounded-2xl">
                <div class="">
                  <div class="justify-center flex-auto p-5 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="flex items-center w-4 h-4 mx-auto -m-1 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" class="flex items-center w-16 h-16 mx-auto text-gray-600" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <div class="p-3 mt-2 space-x-4 text-center md:block">
                    <button class="px-5 py-2 mb-2 text-sm font-medium tracking-wider text-gray-300 transition duration-300 ease-in bg-gray-700 border-2 border-gray-600 rounded-full shadow-sm md:mb-0 hover:border-gray-700 hover:shadow-lg hover:bg-gray-800">
                      Cancel
                    </button>
                    <button class="px-5 py-2 ml-4 text-sm font-medium tracking-wider text-white transition duration-300 ease-in bg-green-400 border-2 border-green-300 rounded-full shadow-sm hover:bg-green-500 hover:shadow-lg hover:border-green-500">Confirm</button>
                  </div>
                </div>
              </div>
