        ...
        <div class="container  m-4">
          <div class="max-w-3xl w-full mx-auto grid gap-4 grid-cols-1">
            ...
            <div class="flex flex-col top-0 z-10">
              <a href="{{Route('productor.edit',$user)}}">
            ...
            <div class="">
              ...
              <div class="form-group mt-2"  x-data="setup()">
                ...
                <section id="especies">  
                  <h1 class="text-center mt-4 font-bold">Editar Cuartel Nro: {{$ficha->cuartel}}</h1>
                </section>
                    ...
                    <div>
                      ...
                      @livewire('agronomo.ficha-create',['user'=>$user->id,'tipo'=>$ficha->id])
