            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @can('Ver procesos_propios')
                        <x-jet-nav-link href="{{ route('procesos.productor.index',auth()->user()->id) }}" :active="request()->routeIs('procesos.*')">
                            {{ __('Procesos') }}
                        </x-jet-nav-link>
                    @endcan
                    @can('Ver procesos_propios')
                    ...
                    <x-jet-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                <button class="flex items-center py-auto text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition">
