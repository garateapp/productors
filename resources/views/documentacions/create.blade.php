                ...
                <div class="px-6 py-4 mt-6 overflow-hidden shadow-md sm:max-w-md sm:rounded-lg"
                    ...
                    <div>
                        ...
                        <div class="mb-2 form-group">
                            ...
                            <div class="mb-2 form-group">
                                <select id="user_id" data-name = 'productor' class="block w-full mt-1" type="text"
                        ...
                        <div class="mb-2 form-group">
                            <input name="id" id="doctoid" type="hidden" value="" data-name="doctoid" />
                            <input name="nombre" id="nombredocto" type="hidden" class="'mt-1 block w-full rounded-lg"
                                placeholder="Nombre de Documento" value="-" required data-name="doctonombre" />
                        ...
                        <div class="mb-2 form-group">
                            ...
                            <input name="descripcion" id="descripciondocto" value="Ingresado por Administrador"
