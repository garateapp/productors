...
class HomeController extends Controller
{
    ...
    public function viewpdf(Recepcion $recepcion) {
        ...
        $distribucion_calibre='https://v1.nocodeapi.com/gonzapv23/screen/FwcFBxzLACvOLnlo/screenshot?url=https://appgreenex.cl/calibre/'.$recepcion->id.'.html&viewport=800x420';
